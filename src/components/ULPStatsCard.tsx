...
export const ULPStatsCard: React.FC<ULPStatsCardProps> = ({ ulpData, onDetailClick, ulpList }) => {
  ...
  const sortedData = requestedOrder.map(name => {
    ...
    return {
      ...
      jumlahWoTotal: found ? found.jumlahWoTotal : 0,
      totalWoPakaiCctv: found ? found.totalWoPakaiCctv : 0,
      persenWo: found ? found.persenWo : "0%",
      persenPenggunaanCctv: found ? found.persenPenggunaanCctv : "0%"
    };
  });
